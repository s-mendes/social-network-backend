...
export class PostDatabase extends BaseDatabase {
  ...
  public getPostWithCreatorName = async (): Promise<PostDBWithCreatorName[]> => {
  ...
  public findPostWithCreatorName = async (id: string): Promise<PostDBWithCreatorName | undefined> => {
